...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <!-- TODO: Remove this in production - role should come from auth -->
        <div
            class="fixed bottom-6 right-6 z-50 flex gap-2 rounded-3xl border border-slate-200 bg-white/90 p-2 shadow-2xl backdrop-blur-xl dark:border-white/20 dark:bg-white/10"
        >
            <button
